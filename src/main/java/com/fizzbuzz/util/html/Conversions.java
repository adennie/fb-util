...
public class Conversions {
    ...
    public static String htmlToPlainText(final String html,
        ...
        FormattingVisitor formatter = new FormattingVisitor(wrap);
    ...
    private static class FormattingVisitor
        ...
        FormattingVisitor(boolean wrap) {
            wrapLines = wrap;
        }
        ...
        public void head(Node node,
            ...
            if (name.equals("p") && (firstParagraph == true)) {
                if (accum.length() > 0)
                    append("\n");
        ...
        private void append(String text) {
            ...
            if (wrapLines && (text.length() + width > maxWidth)) { // won't fit, needs to wrap
