...
public class Entities {
    ...
    static final String[][] HTML40_ARRAY = {
            ...
            // <!-- alef symbol is NOT the same as hebrew letter alef,U+05D0 although the same glyph could be used to
            ...
            // <!-- prod is NOT the same character as U+03A0 'greek capital letter pi' though the same glyph might be
            // used for both -->
            { "sum", "8721" }, // n-ary summation, U+2211 ISOamsb -->
            // <!-- sum is NOT the same character as U+03A3 'greek capital letter sigma' though the same glyph might be
            // used for both -->
            ...
            // <!-- tilde operator is NOT the same character as the tilde, U+007E,although the same glyph might be used
            // to represent both -->
            ...
            // included. Should it be, for symmetry?It is in ISOamsn --> <!ENTITY nsub", "8836"}, //not a subset of,
            // U+2284 ISOamsn -->
            ...
            // <!-- rang is NOT the same character as U+003E 'greater than' or U+203A 'single right-pointing angle
            // quotation mark' -->
            // <!-- Geometric Shapes -->
    ...
    static class PrimitiveEntityMap
    {
        ...
        private final ImmutableMap.Builder<String, Integer> mapNameToValueBuilder = new ImmutableMap.Builder<String, Integer>();
        private Map<Integer, String> mapValueToName;
        private final ImmutableMap.Builder<Integer, String> mapValueToNameBuilder = new ImmutableMap.Builder<Integer, String>();

        public void add(final String name, final int value) {
            mapNameToValueBuilder.put(name, new Integer(value));
            mapValueToNameBuilder.put(value, name);
        }

        public void build() {
            mapNameToValue = mapNameToValueBuilder.build();
            mapValueToName = mapValueToNameBuilder.build();
        }
    ...
    // package scoped for testing
    LookupEntityMap map = new Entities.LookupEntityMap();
